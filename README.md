...
You can build a comprehensive and modern control panel for your Smappee EV Wall using native, out-of-the-box Home Assistant cards. This layout combines real-time grid and charger power metrics with active session statistics and direct configuration controls.

<img src="images/lovelace_card.png" alt="Smappee Lovelace Dashboard Example" height="400">

Add a **Manual** card to your dashboard and paste the following YAML configuration.

> **Note:** Be sure to replace the `entity` IDs in the example below with the exact entity IDs generated by your integration (found under Settings > Devices & Services).

```yaml
type: vertical-stack
cards:
  - type: tile
    entity: sensor.smappee_ev_charger_location_317418_grid_active_power
    name:
      type: entity
    hide_state: false
    vertical: false
  ...
  - type: tile
    entity: sensor.smappee_ev_charger_location_317443_charger_matrix_power
  ...
  - square: false
    ...
    cards:
      - type: tile
        entity: >-
          sensor.smappee_ev_charger_carcharger_acchargingcontroller_145593_charger_status
        name:
          type: entity
        hide_state: false
        vertical: false
      ...
      - type: tile
        entity: >-
          binary_sensor.smappee_ev_charger_carcharger_acchargingcontroller_145593_car_connected
        name:
          type: entity
        vertical: false
        features_position: bottom
  ...
  - type: grid
    ...
    cards:
      - type: tile
        entity: >-
          sensor.smappee_ev_charger_carcharger_acchargingcontroller_145593_session_duration
        name:
          type: entity
        state_content: duration_formatted
        vertical: false
        features_position: bottom
        features:
          - type: trend-graph
      - type: tile
        entity: >-
          sensor.smappee_ev_charger_carcharger_acchargingcontroller_145593_session_energy
        name:
          type: entity
        icon: ""
        color: orange
  ...
  - type: entities
    ...
    entities:
      - entity: >-
          select.smappee_ev_charger_carcharger_acchargingcontroller_145593_charging_mode_select
        icon: ""
        name:
          type: entity
      - entity: >-
          number.smappee_ev_charger_carcharger_acchargingcontroller_145593_charge_percentage_limit
        name:
          type: entity
```
